...
class ColorSonar extends StatefulWidget {
  const ColorSonar({
    ...
    this.innerWaveColor = ColorsManger.primary,
    this.middleWaveColor = const Color.fromARGB(200, 63, 153, 201),
    this.outerWaveColor = const Color.fromARGB(100, 163, 210, 236),
    required this.child,
  }) : super(key: key);
